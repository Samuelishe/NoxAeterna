...
7. Inspect the normalized final image at full size, target card size, and with count/detail crops for faces, hands, countable objects, mechanisms, and frame edges. State literal observations before comparing them with the brief or record. Never infer hidden, occluded, incomplete, or merely prompted objects.
