...
- the first three shipped Lupus Noctis Tarot illustrations were generated by the project owner through the built-in OpenAI/Codex image-generation workflow and then manually selected; their generation provenance and unresolved release-rights verification are recorded in `docs/THIRD-PARTY.md` and the pack owner document;
