...
- A13 is owner-accepted and promoted: `minor.cups.ten`, `major.hermit`, `major.fool`, and `minor.pentacles.ace` bring Lupus Noctis to 33/78 production illustrations. The three A14 candidates remain Pending owner review.
...
Continue ART-LN with owner visual review of the three Pending A14 candidates. The post-A14 batch remains unselected, and AP1 does not start automatically.
...
- Lupus Noctis A0 and A1 remain rejected. The owner accepted all A2, A4, A5, A6, A7, A8, A9, A10, A11, the two promoted A12 cards, and all four A13 cards; the built-in partial pack now owns 33/78 production illustrations and uses the existing programmatic face for omitted cards. A14 remains a bounded three-card Pending review batch outside the manifest. Detailed card state, prompts, provenance, hashes, and casting policy belong only to `resources/assets/tarot/artwork-packs/lupus-noctis/LUPUS-NOCTIS.md`.
...
- Owner visual review of A14 is the current ART-LN gate; the post-A14 batch remains deliberately unselected. AP1–AP5 and PKG1 are staged work, not blockers for ART-LN.
