...
- A10 is visually accepted by the owner: `major.temperance`, `minor.swords.ten`, and `minor.wands.queen` are promoted into the Lupus Noctis partial pack, which now contains 24/78 production illustrations. The independent A11 compassionate power / disengagement / material stewardship candidates remain Pending owner review.
...
Continue ART-LN with owner visual review of the three Pending A11 candidates. The post-A11 batch remains unselected, and AP1 does not start automatically.
...
- Lupus Noctis A0 and A1 remain rejected. The owner accepted all A2, A4, A5, A6, A7, A8, A9, and A10 cards; the built-in partial pack now owns 24/78 production illustrations and uses the existing programmatic face for omitted cards. A11 remains a bounded Pending review batch outside the manifest. Detailed card state, prompts, provenance, hashes, and casting policy belong only to `resources/assets/tarot/artwork-packs/lupus-noctis/LUPUS-NOCTIS.md`.
...
- Owner visual review of A11 is the current ART-LN gate; the post-A11 batch remains deliberately unselected. AP1–AP5 and PKG1 are staged work, not blockers for ART-LN.
