...
- A17 is owner-accepted and promoted: `major.devil`, `minor.cups.three`, and corrected `minor.swords.three` bring Lupus Noctis to 45/78 production illustrations. Three of Swords retains the full history of its initial two-sword-plus-empty-scabbard defect, the incorrect prior technical count, owner detection, and successful targeted independent correction with generation count two. The three A18 candidates remain Pending owner review outside the manifest and Release output.
...
Continue ART-LN with owner visual review of the three Pending A18 candidates. The post-A18 batch remains deliberately unselected, and A18-P, A19, and AP1 do not start automatically.
...
- Owner visual review of A18 is the current ART-LN gate; the post-A18 batch remains deliberately unselected. AP1–AP5 and PKG1 are staged work, not blockers for ART-LN.
