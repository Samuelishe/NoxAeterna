...
- A14 is owner-accepted and promoted: `major.judgement`, corrected `minor.swords.six`, and `minor.wands.two` bring Lupus Noctis to 36/78 production illustrations. Six of Swords retains the honest initial five-sword miscount and successful `3 + 3 = 6` correction history. The three A15 candidates remain Pending owner review.
...
Continue ART-LN with owner visual review of the three Pending A15 candidates. The post-A15 batch remains unselected, and AP1 does not start automatically.
...
- Lupus Noctis A0 and A1 remain rejected. The owner accepted all A2, A4, A5, A6, A7, A8, A9, A10, A11, the two promoted A12 cards, all four A13 cards, and all three A14 cards; the built-in partial pack now owns 36/78 production illustrations and uses the existing programmatic face for omitted cards. A15 remains a bounded three-card Pending review batch outside the manifest. Detailed card state, prompts, provenance, hashes, and casting policy belong only to `resources/assets/tarot/artwork-packs/lupus-noctis/LUPUS-NOCTIS.md`.
...
- Owner visual review of A15 is the current ART-LN gate; the post-A15 batch remains deliberately unselected. AP1–AP5 and PKG1 are staged work, not blockers for ART-LN.
