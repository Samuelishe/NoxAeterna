...
- A7 is visually accepted by the owner: `major.emperor`, `minor.cups.five`, and `minor.wands.page` are promoted into the Lupus Noctis partial pack, which now contains 15/78 production illustrations. The independent A8 justice / hardship / emotional stewardship candidates remain Pending owner review.
...
Continue ART-LN with owner visual review of the three Pending A8 candidates. The post-A8 batch remains unselected, and AP1 does not start automatically.
...
- Lupus Noctis A0 and A1 remain rejected. The owner accepted all A2, A4, A5, A6, and A7 cards; the built-in partial pack now owns 15/78 production illustrations and uses the existing programmatic face for omitted cards. A8 remains a bounded Pending review batch outside the manifest. Detailed card state, prompts, provenance, hashes, and casting policy belong only to `resources/assets/tarot/artwork-packs/lupus-noctis/LUPUS-NOCTIS.md`.
...
- Owner visual review of A8 is the current ART-LN gate; the post-A8 batch remains deliberately unselected. AP1–AP5 and PKG1 are staged work, not blockers for ART-LN.
