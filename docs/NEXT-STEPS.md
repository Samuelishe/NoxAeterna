...
The repository-foundation wave, P1, S1, and T0-A are accepted with green hosted evidence. A17 is accepted and promoted, Lupus Noctis now has 45/78 accepted production illustrations with prototype fallback for omitted cards, and the three A18 candidates remain Pending.

Immediate next steps:

1. **ART-LN:** visually review the three A18 candidates and decide whether to accept, reject, or correct them. The post-A18 batch remains deliberately unselected; do not begin A18-P, A19, or AP1 automatically. Art production in the stable repository structure does not wait for runtime import infrastructure.
